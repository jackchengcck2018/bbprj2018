...
//		$pattern = "/([\w-:\*]*)(?:\#([\w-]+)|\.([\w-]+))?(?:\[@?(!?[\w-]+)(?:([!*^$]?=)[\"']?(.*?)[\"']?)?\])?([\/, ]+)/is";
	...
	*/
	...
	/**
	 * Function to try a few tricks to determine the displayed size of an img on the pages.
	 * NOTE: This will ONLY work on an IMG tag. Returns FALSE on all other tag types.
	 *
	 * @author John Schlick
	 * @version April 19 2012
	 * @return array an array containing the 'height' and 'width' of the image on the pages or -1 if we can't figure it out.
	 */
	function get_display_size()
	{
		...
		// If the class or id is specified in a SEPARATE css file thats not on the pages, go get it and do what we were just doing for the ones on the pages.
...
class simple_html_dom
{
	...
	// PAPERG - dkchou - added this to try to identify the character set of the pages we have just parsed so we know better how to spit it out later.
