...
if (stripos($_SERVER['SCRIPT_NAME'], 'apps/phpgrid-custom-crm')) {
    define('PHPGRID_DB_HOSTNAME', 'bidbuy.cz77zdslbgde.ap-northeast-1.rds.amazonaws.com:3306'); // database host name
    define('PHPGRID_DB_USERNAME', 'bidbuyer');     // database user name
    define('PHPGRID_DB_PASSWORD', 'bidbidbuy123456'); // database password
    define('PHPGRID_DB_NAME', 'bidbuy'); // database name
